...
Page({
  ...
  data: {
    ...
    Array: ['太原南', '北京西', '石家庄北'],
    page: 0,
    Arraycity: ['太原南', '北京西', '石家庄北'],
    pageTo: 0,
    ArrayArrive: ['杭州', '天津', '成都'],
    arrive: 0,
    ArrayArriveto: ['天津', '杭州', '杭州'],
    arriveTo: 0,
    date: '2018-09-01',
    dateto: '2018-12-01',
    ArrayPlan: ['火车', '飞机', '轮船'],
    Plan: 0,
    ArrayPlanto: ['火车', '飞机', '轮船'],
    Planto: 0,
    ArrayNum: ['G620', 'G601'],
    Num: 0,
    ArrayNumto: ['G620', 'G601'],
    Numto: 0,
    go: '2018-09-01',
    ArrayUntil: ['6：20 - 8：20', '11.30 - 14：30', '18：00 - 22：00'],
    until: 0,
    ArrayUntilto: ['6：20 - 8：20', '11.30 - 14：30', '18：00 - 22：00'],
    untilto: 0,
    ArrayPlaneto: ['8：20 - 10：20', '13.30 - 15：30', '18：00 - 22：00'],
    planeto: 0,
    ArrayWay: ['火车', '飞机', '轮船'],
    way: 0,
    ArrayFly: ['G620', 'G601'],
